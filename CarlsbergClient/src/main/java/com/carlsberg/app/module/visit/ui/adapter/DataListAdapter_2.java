...
public class DataListAdapter_2 extends BaseAdapter {

    private final LayoutInflater mInflater;
    List<TaskScore> data = new ArrayList<>();

    public DataListAdapter_2(Context context) {
    ...
    public List<TaskScore> getData() {
        return data;
    }

    public void setData(List<TaskScore> data) {
        this.data = data;
